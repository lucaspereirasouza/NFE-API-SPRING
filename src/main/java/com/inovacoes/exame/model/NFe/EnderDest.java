...
public class EnderDest {
	...
	public EnderDest(Long id, String xLgr, String nro, String xBairro, String xMun, String uF, String cEP, String xPais,
			String fone) {
		this.id = id;
		this.xLgr = xLgr;
		this.nro = nro;
	...
	public String toString() {
		return "EnderDest [id=" + id + ", xLgr=" + xLgr + ", nro=" + nro + ", xBairro=" + xBairro + ", xMun=" + xMun
